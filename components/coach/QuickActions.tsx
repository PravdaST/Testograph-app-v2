...
const QUICK_ACTIONS: QuickAction[] = [
  {
    id: 'nutrition',
    label: 'Хранене',
    prompt: 'Какво да ям днес за оптимален тестостерон?',
    icon: Utensils,
  ...
  },
  {
    id: 'workout',
    label: 'Тренировка',
    prompt: 'Дай ми съвети за днешната тренировка.',
    icon: Dumbbell,
  ...
  },
  {
    id: 'sleep',
    label: 'Сън',
    prompt: 'Как да подобря качеството на съня си?',
    icon: Moon,
  ...
  },
  {
    id: 'supplements',
    label: 'Добавки',
    prompt: 'Кога е най-добре да взема TestoUp?',
    icon: Pill,
  ...
  },
  {
    id: 'testosterone',
    label: 'Тестостерон',
    prompt: 'Какво още мога да направя за тестостерона си?',
    icon: TrendingUp,
  ...
  },
  {
    id: 'motivation',
    label: 'Мотивация',
    prompt: 'Имам нужда от мотивация днес.',
    icon: Sparkles,
